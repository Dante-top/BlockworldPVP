    ...
    return (
        <div className={`container d-flex justify-content-center align-items-center flex-column ${styles.terms}`}>
            ...
            <div className={`${styles.text_start}`}>
                <p>
                    BlockWorld PVP ("us", "we", or "our") operates the website.
                </p>
            </div>
            <p>
            ...
            <div className={`${styles.text_start}`}>
                <p>
                    BlockWorld PVP uses the collected data for various purposes:
                </p>
            </div>
            ...
            <p>BlockWorld PVP will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information
            </p>

            <h3>IV. DISCLOSURE OF DATA</h3>
            <p>Legal Requirements BlockWorld PVP may disclose your Personal Data in the good faith belief that such action is necessary to:
            </p>

            <p>To comply with a legal obligation To protect and defend the rights or property of BlockWorld PVP To prevent or investigate possible wrongdoing in connection with the Service To protect the personal safety of users of the Service or the public To protect against legal liability V. SECURITY OF DATA The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
            </p>

            <h3>VI. SERVICE PROVIDERS
            </h3>
            ...
            <div className={`${styles.text_start}`}>
                <p>If you have any questions about this Privacy Policy, please contact us directly on Discord.</p>
            </div>
            <p>If you would like to know what kind of information we are storing regarding your user, please reach out to us on Discord and use the subject “SAR: user”</p>

            <p>If you would like your personal data deleted, please reach out to us on Discord and use the subject: “Delete:User”</p>
        </div>
    );
}
