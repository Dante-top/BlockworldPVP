...
function Terms() {
    return (
        <div className={`container d-flex justify-content-center align-items-center flex-column ${styles.terms}`}>
            ...
            <p>
                These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you") and BlockWorld PVP LLC (“we", “us", or “our") concerning your access to and use of the www.blockworldpvp.com website and the BlockWorld PVP app as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site" and the “App"). BlockWorldPVP  is a distributed application that is currently running on the Solana Network (the "Blockchains"), using specially-developed smart contracts (each, a “Smart Contract”) to enable users to own, transfer, battle, and breed genetically unique digital creatures. It also enables users to own and transfer other digital assets like plots of land and items. These assets can then be visualized on a website that the user can interact with (the "Site"). The Smart Contracts and the Site are collectively referred to in these Terms as the “App”. Using the App, users can view their assets and use the Smart Contracts to acquire, trade, battle, and breed creatures with other App users.
            </p>
            <p>
                WE ARE ONLY WILLING TO MAKE THE APP, THE SMART CONTRACTS, AND THE SITE AVAILABLE TO YOU IF YOU ACCEPT ALL OF THESE TERMS. BY USING THE APP, THE SMART CONTRACTS, THE SITE, OR ANY OTHER OFFICIAL BLOCKWORLD PVP PRODUCT, YOU ARE CONFIRMING THAT YOU HAVE READ, UNDERSTAND, AND AGREE TO BE BOUND BY ALL OF THESE TERMS OF USE. IF YOU DO NOT AGREE AND/OR ACCEPT ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE, THE APP AND THE SMART CONTRACTS AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>
            <p>
            ...
            <p>
                Provided that you own, or get permission from someone who owns a BlockWorld PVP asset, you are granted a limited license to create fan-art which can be used commercially given that you follow the terms set herein:
            </p>
            <p>
                Fan artwork must not use official BlockWorld PVP assets (the BlockWorld PVP logo, BlockWorld PVP Shard logo, SLP logo, etc), but creating derivate non-commercial official BlockWorld-assets as inspiration is acceptable.
            </p>
            <p>
                The artwork must clearly state “BlockWorld PVP Fanart”, link to https://www.blockworldpvp.com/, and link directly to the BlockWorld PVP that is being used for inspiration.
            </p>
            <p>
                A BlockWorld PVP NFT can be used to generate a maximum of $10,000 in revenue before an official license agreement has to be signed. The revenue can come from either fanart (tokenized or physical) or merchandise (t-shirts, mugs, hoodies, etc).
            </p>
            ...
            <p>
                BlockWorld PVP Limited reserves the right to choose which markets and jurisdictions to conduct its business and may restrict or refuse, at its sole discretion, the provision of BlockWorld PVP services in certain countries or regions.
            </p>
            <h3>
                3. USER REGISTRATION
            </h3>
            ...
            <p>
                ...
                Engage in any practice that aims to manipulate the outcome of any BlockWorld PVP match, whether in the arena or tournaments. All players should play to the best of their abilities and any sort of match-fixing, win-trading, or colluding between competitors is strictly prohibited.
            </p>
            <h3>
                5. FEE AND PAYMENT
            </h3>

            <p>Any purchases from the site or marketplace will be done through smart contracts on a blockchain using a Phantom wallet. Any financial transactions that you engage in will be conducted solely through the Blockchain via a Phantom wallet. We will have no insight into or control over these payments or transactions, nor do we have the ability to reverse any transactions. With that in mind, we will have no liability to you or to any third party for any claims or damages that may arise as a result of any transactions that you engage in via the Site and/or the App or using the Smart Contracts, or any other transactions that you conduct via the Solana network.</p>

            <p>Solana requires the payment of a transaction fee (a “Gas Fee”) for every transaction that occurs on the Solana network. The Gas Fee funds the network of computers that run the decentralized Solana network. This means that you will need to pay a Gas Fee for each transaction that occurs via the App.</p>

            <p>In addition to the Gas Fee, each time you utilize a Smart Contract to conduct a transaction with another user via the App, you authorize us to collect a commission of 2% of the total value of that transaction (each, a “Commission”). You acknowledge and agree that the Commission will be transferred directly to us through the Solana Network as a part of the transaction.</p>

            <p>As between us, you will be solely responsible to pay any and all sales, use, value-added and other taxes, duties, and assessments (except taxes on our net income) now or hereafter claimed or imposed by any governmental authority (collectively, “Taxes”) associated with your use of the game. Except for income taxes levied on BlockWorld PVP, you: (i) will pay or reimburse us for all national, federal, state, local, or other taxes and assessments of any jurisdiction, including value-added taxes and taxes as required by international tax treaties, customs or other import or export taxes, and amounts levied in lieu thereof based on charges set, services performed or payments made hereunder, as are now or hereafter may be imposed under the authority of any national, state, local or any other taxing jurisdiction; and (ii) shall not be entitled to deduct the amount of any such taxes, duties or assessments from payments made to us pursuant to these Terms.</p>

            <h3>6. SUBMISSION</h3>
            <p>You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other information regarding the Site, the App and the Smart Contracts (“Submissions") provided by you to us are non-confidential and should become our sole property. We should own exclusive rights, including all intellectual property rights, and should be entitled to the unrestricted use and dissemination of these Submissions to any lawful purpose, commercial, or otherwise, without acknowledgment or compensation for you. You hereby waive any moral rights to any such Submissions, and you hereby warrant that any such Submissions are original with you or that you have the right to submit such Submissions. You agree there should be no recourse against us for any alleged or actual infringement or misappropriation of any proprietary right in your Submissions.</p>

            <h3>7. THIRD-PARTY WEBSITE AND CONTENT</h3>
            ...
            <p>This Terms of Use and your use of the Site, the App, and the Smart Contracts are governed by and constructed in accordance with the laws of the Cayman Islands applicable to agreements made and to be entirely performed in the Cayman Island, without regard to its conflicts of law principles.</p>

            <h3>11. DISPUTE RESOLUTION</h3>
            <h4>11.1 Informal negotiations</h4>
            ...
            <h4>11.2 Binding Arbitration</h4>

            <p>If a Party is unable to resolve a Dispute through informal negotiations, the Disputes (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association (“AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer-Related Disputes (“AAA Consumer Rules"), both of which are available at the AAA website www.adr.org. Your arbitration fees and your share of arbitration compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. If such costs are determined by the arbitrator to be excessive, we will pay all the arbitration fees and expenses. Except where otherwise required by the applicable AA rules or applicable law, the arbitration can take place in the Cayman Islands. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgement on the award entered by the arbitrator.</p>

            <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in the Cayman Islands, and the Parties hereby consent to and waive all defenses of lack of personal jurisdiction, and forum non-conveniens with respect to venue and jurisdiction in such state and federal courts.</p>

            <p>In no event shall any Dispute brought by either Party related in any way to the Site, the App and the Smart Contracts be commenced more than one (1) year after the cause of the action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed or jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.</p>

            <h4>11.3 Exceptions to the Informal Negotiations and Arbitration</h4>
            ...
            <p>WE WILL NOT BE RESPONSIBLE OR LIABLE TO YOU FOR ANY LOSSES YOU INCUR AS THE RESULT OF YOUR USE OF THE SOLANA NETWORK, THE PHANTOM ELECTRONIC WALLET,, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES OR CLAIMS ARISING FROM: (A) USER ERROR, SUCH AS FORGOTTEN PASSWORDS OR INCORRECTLY CONSTRUED SMART CONTRACTS OR OTHER TRANSACTIONS; (B) SERVER FAILURE OR DATA LOSS; (C) CORRUPTED WALLET FILES; (D) UNAUTHORIZED ACCESS OR ACTIVITIES BY THIRD PARTIES, INCLUDING BUT NOT LIMITED TO THE USE OF VIRUSES, PHISHING, BRUTE FORCING OR OTHER MEANS OF ATTACK AGAINST THE APP, SOLANA NETWORK, OR THE PHANTOM ELECTRONIC WALLET.</p>

            <p>BLOCKWORLD PVP NFTS ARE INTANGIBLE DIGITAL ASSETS THAT EXIST ONLY BY VIRTUE OF THE OWNERSHIP RECORD MAINTAINED ON THE SOLANA NETWORK. ALL SMART CONTRACTS ARE CONDUCTED AND OCCUR ON THE DECENTRALIZED LEDGER WITHIN THE SOLANA NETWORK. BlockWorld PVP LIMITED HAS NO CONTROL OVER AND MAKES NO GUARANTEES OR PROMISES WITH RESPECT TO SMART CONTRACTS. BlockWorld PVP IS NOT RESPONSIBLE FOR LOSSES DUE TO BLOCKCHAINS OR ANY OTHER FEATURES OF THE PHANTOM NETWORK, THE PHANTOM ELECTRONIC WALLET. INCLUDING BUT NOT LIMITED TO LATE REPORT BY DEVELOPERS OR REPRESENTATIVES (OR NO REPORT AT ALL) OF ANY ISSUES WITH THE BLOCKCHAIN SUPPORTING THE SOLANA NETWORK, INCLUDING FORKS, TECHNICAL NODE ISSUES, OR ANY OTHER ISSUES HAVING FUND LOSSES AS A RESULT.</p>
            ...
            <p>YOU AGREE AND ACKNOWLEDGE THAT WE HAVE MADE THE SITE, THE APP AND THE SMART CONTRACTS AVAILABLE TO YOU AND ENTERED INTO THESE TERMS IN RELIANCE UPON THE WARRANTY DISCLAIMERS AND LIMITATIONS OF LIABILITY SET FORTH HEREIN, WHICH REFLECT A REASONABLE AND FAIR ALLOCATION OF RISK BETWEEN THE PARTIES AND FORM AN ESSENTIAL BASIS OF THE BARGAIN BETWEEN US. WE WOULD NOT BE ABLE TO PROVIDE THE SITE, THE APP AND THE SMART CONTRACTS TO YOU WITHOUT THESE LIMITATIONS.</p>

            <p>SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, AND SOME JURISDICTIONS ALSO LIMIT DISCLAIMERS OR LIMITATIONS OF LIABILITY FOR PERSONAL INJURY FROM CONSUMER PRODUCTS, SO THE ABOVE LIMITATIONS MAY NOT APPLY TO PERSONAL INJURY CLAIMS.</p>

            <h3>14. ASSUMPTION OF RISK</h3>
            <div className={`${styles.text_start}`}>
                <p>You accept and acknowledge each of the following:</p>
            </div>

            <p>A. The prices of blockchain assets are extremely volatile. Fluctuations in the price of other digital assets could materially and adversely affect the value of your BlockWorld PVP NFTs, which may also be subject to significant price volatility. We cannot guarantee that any purchasers of BlockWorld PVP assets will not lose money.</p>

            <p>B. You are solely responsible for determining what, if any, taxes apply to your BlockWorld-related transactions. BlockWorld PVP is not responsible for determining the taxes that apply to your transactions on the App, the Site, or the Smart Contracts.</p>

            <p>C. The App does not store, send, or receive BlockWorld PVP assets. This is because BlockWorld PVP assets exist only by virtue of the ownership record maintained on the App’s supporting blockchain on the Solana network. Any transfer of BlockWorld PVP assets occurs only on the Solana network.</p>

            <p>D. There are risks associated with using an Internet-based currency, including, but not limited to, the risk of hardware, software and Internet connections, the risk of malicious software introduction, and the risk that third parties may obtain unauthorized access to information stored within your wallet. You accept and acknowledge that BlockWorld PVP will not be responsible for any communication failures, disruptions, errors, distortions or delays you may experience when using the Solana network, however caused.</p>

            <p>E. A lack of use or public interest in the creation and development of distributed ecosystems could negatively impact the development of the BlockWorld PVP ecosystem, and therefore the potential utility or value of BlockWorld PVP assets.</p>

            <p>F. The regulatory regime governing blockchain technologies, cryptocurrencies, and tokens is uncertain, and new regulations or policies may materially adversely affect the development of the BlockWorld ecosystem, and therefore the potential utility or value of BlockWorld PVP assets.</p>
